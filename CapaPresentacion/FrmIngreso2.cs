...
{
    public partial class FrmIngreso2 : Form
    {
        ...
        public void Mostrar()
        {
            this.dataListado.DataSource = NIngreso2.Mostrar();
        ...
        {
            this.dataListado.DataSource = NIngreso2.BuscarFechas(this.dtFecha1.Value.ToString("dd/MM/yyyy"), this.dtFecha2.Value.ToString("dd/MM/yyyy"));
            this.OcultarColumnas();
            this.AlternarColorFilasDataGridView(dataListado);
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        {
            this.dataListado.DataSource = NIngreso2.Buscar_por_nroRecibo(this.txtBuscar.Text);
            this.OcultarColumnas();
            this.AlternarColorFilasDataGridView(dataListado);
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        private void FrmIngreso2_Load(object sender, EventArgs e)
        {
            this.Top = 0;
            this.Left = 0;
            this.Mostrar();
        ...
        {
            FrmEditarIngreso2 frm =new  FrmEditarIngreso2();
        ...
        {
            FrmReporteIngreso2PorID frm = new FrmReporteIngreso2PorID();
