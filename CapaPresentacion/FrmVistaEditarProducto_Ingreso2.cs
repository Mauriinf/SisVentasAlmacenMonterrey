...
{
    public partial class FrmVistaEditarProducto_Ingreso2 : Form
    {
        public FrmVistaEditarProducto_Ingreso2()
        {
            InitializeComponent();
        }
        //Método Mostrar
        ...
        private void FrmVistaEditarProducto_Ingreso2_Load(object sender, EventArgs e)
        {
            this.Mostrar();
        }
        ...
        {
            FrmEditarDetalleIngreso2 form = FrmEditarDetalleIngreso2.GetInstancia();
            string par1, par2;
