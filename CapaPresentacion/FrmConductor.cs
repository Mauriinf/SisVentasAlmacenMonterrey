...
namespace CapaPresentacion
{
    public partial class FrmConductor : Form
    {
        ...
        private void tam()
        {
            dataListado.Columns["Id"].Width = 60;
            ...
            dataListado.Columns["NroLicencia"].Width = 110;
            dataListado.Columns["Placa"].Width = 110;
                ...
                if (Opcion == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow row in dataListado.Rows)
                    {
                        if (Convert.ToBoolean(row.Cells[0].Value))
                        {
                            ...
                            Rpta = NConductor.Eliminar(Convert.ToInt32(Id));//cambiar
                            aux++;
                            if (Rpta.Equals("OK"))
                            {
        ...
        {
            FrmEditarConductor frm = new FrmEditarConductor();
            frm.txtId.Text = dataListado.CurrentRow.Cells["Id"].Value.ToString();
            ...
            frm.txtLicencia.Text = dataListado.CurrentRow.Cells["NroLicencia"].Value.ToString();
            frm.txtPlaca.Text = dataListado.CurrentRow.Cells["Placa"].Value.ToString();
            frm.cbSexo.Text = dataListado.CurrentRow.Cells["Sexo"].Value.ToString();
            frm.txtcolor.Text = dataListado.CurrentRow.Cells["Color_Vehiculo"].Value.ToString();
            frm.ShowDialog();
            Mostrar();
        }
        ...
        {
            FrmReporteConductores frm = new FrmReporteConductores();
            frm.ShowDialog();
        }
    }
}
