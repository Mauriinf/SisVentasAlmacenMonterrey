...
{
    public partial class FrmVistaConductor_Ingreso : Form
    {
        public FrmVistaConductor_Ingreso()
        {
            InitializeComponent();
        }
        ...
        private void FrmVistaConductor_Ingreso_Load(object sender, EventArgs e)
        {
            this.Mostrar();
        }
