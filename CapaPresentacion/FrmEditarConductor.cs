            ...
            try
            {
                ...
                else
                {
                    ...
                    if (Opcion == DialogResult.OK)
                    {
                        ...
                        rpta = NConductor.Editar(Convert.ToInt32(this.txtId.Text), this.txtNombre.Text.Trim().ToUpper(), this.txtPaterno.Text.Trim().ToUpper(), this.txtMaterno.Text.Trim().ToUpper(), this.txtLicencia.Text.Trim().ToUpper(), this.txtPlaca.Text.Trim(), this.cbSexo.Text.Trim().ToUpper(), this.txtcolor.Text.Trim().ToUpper());
                        if (rpta.Equals("OK"))
                        {
